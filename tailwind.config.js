...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        // Elegant display font for headlines - classic newspaper masthead feel
        display: ['"Playfair Display"', 'Georgia', 'serif'],
        // Refined serif for body text - easy to read, classic newspaper feel
        body: ['"Libre Baskerville"', '"Times New Roman"', 'serif'],
        // Accent font for dates, labels, and small details
        accent: ['"Cormorant Garamond"', 'Georgia', 'serif'],
      },
      colors: {
        // Refined newspaper color palette
      ...
      boxShadow: {
        ...
        'elegant-lg': '0 10px 40px -10px rgba(0, 0, 0, 0.15), 0 4px 16px -4px rgba(0, 0, 0, 0.1)',
